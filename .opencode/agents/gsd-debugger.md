...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/bang/project/slot-booking-AI/.opencode
                  → checks /home/bang/project/slot-booking-AI/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/bang/project/slot-booking-AI/.opencode/get-shit-done
                  → writes to /home/bang/project/slot-booking-AI/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/bang/project/slot-booking-AI/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/bang/project/slot-booking-AI/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/bang/project/slot-booking-AI/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
