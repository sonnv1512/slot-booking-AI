...
Use template from `/home/bang/project/slot-booking-AI/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/bang/project/slot-booking-AI/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/bang/project/slot-booking-AI/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
