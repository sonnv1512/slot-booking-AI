...
- Usage: Reference from command with `@/home/bang/project/slot-booking-AI/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/bang/project/slot-booking-AI/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/bang/project/slot-booking-AI/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
