...
- **Global scope**: `/home/bang/project/slot-booking-AI/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/bang/project/slot-booking-AI/.opencode/notes/`)
...
2. Glob `/home/bang/project/slot-booking-AI/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/bang/project/slot-booking-AI/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/bang/project/slot-booking-AI/.opencode/notes/` — works in any directory
